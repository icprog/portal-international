    ...
    <template v-if="curLanguage == 'CH'">
      <div class="logo">
        <div class="container u-cb">
          <a href="#" class="u-fl">
            <img src="../../assets/img/title.png" height="35.6px" alt />
          </a>
      ...
      <nav class="nav">
        <ul class="container menu-box u-cb">
          ...
          <router-link to="/FR/service" tag="li">
            <span class="menu-item" style="line-height:25px"
              >Contenu et processus</span
            >
          </router-link>

          <router-link to="/FR/vision" tag="li">
            <span class="menu-item" style="line-height:25px"
              >Vision, mission et avantage</span
            >
          </router-link>

          <router-link to="/FR/trade" tag="li">
            <span class="menu-item" style="line-height:25px"
              >Métiers et secteurs concentrées</span
            >
          </router-link>

          <router-link to="/FR/custom" tag="li">
            <span class="menu-item" style="line-height:25px"
              >Clientèle et commentaires</span
            >
          </router-link>
        </ul>
      </nav>
